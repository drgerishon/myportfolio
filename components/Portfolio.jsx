  ...
  return (
    <div id="portfolio" className='w-full'>
        <div className='max-w-screen-xl mx-auto px-8 py-16 text-center md:text-left'>
            ...
            uppercase text-blue-500 font-bold'>Sample Projects</h2>
            <p className='py-4 max-w-lg text-blue-600'>Here are sample display of my past projects that i have
                 developed in my jornet to become a professional wed developer</p>
                ...
                <Link key={id} href={`/portfolio/${url}`}>
                    <div className='cursor-pointer group shadow-md
                     shadow-gray-600 overflow-hidden rounded-md'>
                        ...
                        <h2 className='text-center text-base capitalize my-4 font-light
                         duration-200 group-hover:underline underline-offset-4'>{title}</h2>
                    </div>
                </Link>
            ))}
       </div>
       ...
       <Link href="/portfolio">
          <div className="group flex items-center justify-center my-8
